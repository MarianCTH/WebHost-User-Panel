    ...
    <div className='card mb-5 mb-xl-10'>
      ...
      >
        <div className='card-title m-0'>
          <h3 className='fw-bolder m-0'>Notificări</h3>
        </div>
      </div>
      ...
      <div id='kt_account_notifications' className='collapse show'>
        <form className='form'>
            ...
            <div className='table-responsive'>
              <table className='table table-row-dashed border-gray-300 align-middle gy-6'>
                <tbody className='fs-6 fw-bold'>
                  <tr>
                    <td className='min-w-250px fs-4 fw-bolder'>Notificări</td>
                  ...
                  <tr>
                    <td>Modificări termeni și condiții</td>
                    <td>
                      <div className='form-check form-check-solid'>
                        <input
                          className='form-check-input'
                  ...
                  <tr>
                    <td>Modificări asupra serviciilor</td>
                    <td>
                      <div className='form-check form-check-solid'>
                        <input
                          className='form-check-input'
                  ...
                  <tr>
                    <td className='border-bottom-0'>Modificări asupra contului</td>
          ...
          <div className='card-footer d-flex justify-content-end py-6 px-9'>
            <button className='btn btn-light btn-active-light-primary me-2'>Șterge modificările</button>
